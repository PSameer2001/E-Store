...
const ProductDetail = (props) => {
  ...
  const getallProductImageData = async (product_id) => {
    const res = await axios.get(`${process.env.REACT_APP_SERVER_URL}/getallImageProductData/${product_id}`);
    const data = res.data;
    if (data) {
  ...
  const getProductData = async (product_id) => {
    const res = await axios.get(`${process.env.REACT_APP_SERVER_URL}/getProductData/${product_id}`);
  ...
  const getProductReviewData = async (product_id) => {
    const res = await axios.get(`${process.env.REACT_APP_SERVER_URL}/getProductReviewData/${product_id}`);
    const data = res.data;
