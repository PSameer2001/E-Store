...
const Profile = (props) => {
  ...
  const UpdateData = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${process.env.REACT_APP_SERVER_URL}/updateUser`, formObject);
  ...
  const UpdatePassword = async () => {
    try {
      ...
      const res = await axios.post(`${process.env.REACT_APP_SERVER_URL}/updatePassword`, {
        email,
        currentPassword,
        newPassword,
        confirmNewPassword,
