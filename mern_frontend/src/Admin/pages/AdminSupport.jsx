...
const AdminSupport = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setIsLoading(true);
      const res = await axios.post(`${process.env.REACT_APP_SERVER_URL}/updateTicketStatus`, {
  ...
  const getallTicketData = async () => {
    const res = await axios.get(`${process.env.REACT_APP_SERVER_URL}/getallTicketData`);
    const data = res.data;
    setRows(data);
  };
