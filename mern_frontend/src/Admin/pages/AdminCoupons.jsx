...
const AdminCoupons = () => {
  ...
  const handleSubmit = async (e) => {
    try {
      e.preventDefault();
      setIsLoading(true);
      const res = await axios.post(`${process.env.SERVER_URL}/addCoupon`, coupondata);
  ...
  const handledeleteCoupon = async (id) => {
    try {
      const res = await axios.post(`${process.env.SERVER_URL}/deleteCoupon`, { id });
  ...
  const handleEditSubmit = async (event) => {
    ...
    try {
      setIsLoading(true);
      const res = await axios.post(`${process.env.SERVER_URL}/editCoupon`, editcoupondata);
      let message = res.data.message;
