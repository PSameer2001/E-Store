...
const AdminCoupons = () => {
  ...
  const getallCouponData = async () => {
    const res = await axios.get(`${process.env.REACT_APP_SERVER_URL}/getallCouponData`);
    const data = res.data;
    setRows(data);
  };
  ...
  const handleSubmit = async (e) => {
    try {
      e.preventDefault();
      setIsLoading(true);
      const res = await axios.post(`${process.env.REACT_APP_SERVER_URL}/addCoupon`, coupondata);
  ...
  const handledeleteCoupon = async (id) => {
    try {
      const res = await axios.post(`${process.env.REACT_APP_SERVER_URL}/deleteCoupon`, { id });
  ...
  const handleEditSubmit = async (event) => {
    ...
    try {
      setIsLoading(true);
      const res = await axios.post(`${process.env.REACT_APP_SERVER_URL}/editCoupon`, editcoupondata);
      let message = res.data.message;
