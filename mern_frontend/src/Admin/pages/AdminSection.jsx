...
const AdminSection = () => {
  ...
  const handleSubmit = async (e) => {
    try {
      e.preventDefault();
      setIsLoading(true);
      const res = await axios.post(`${process.env.REACT_APP_SERVER_URL}/addSection`, sectiondata);
  ...
  const handledeleteSection = async (id) => {
    try {
      const res = await axios.post(`${process.env.REACT_APP_SERVER_URL}/deleteSection`, { id });
  ...
  const handleEditSubmit = async (event) => {
    ...
    try {
      setIsLoading(true);
      const res = await axios.post(`${process.env.REACT_APP_SERVER_URL}/editSection`, editsectiondata);
      let message = res.data.message;
